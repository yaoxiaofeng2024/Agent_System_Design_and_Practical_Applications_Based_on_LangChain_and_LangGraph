...
print("=" * 50)
key_points = extraction_chain.invoke({"feedback_text": customer_feedback})
print(key_points)
...
print("=" * 50)
classified_points = classification_chain.invoke({"key_points": key_points})
...
print("=" * 50)
final_report = summarize_chain.invoke({"classified_points": classified_points})
print(final_report)
